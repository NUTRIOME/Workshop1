...
```{r}
#Create the "dds" object from count data and metadata. The experimental design compares the diet intervention (LP versus HP). This is a design if you have only one variable to compare experimental groups.
