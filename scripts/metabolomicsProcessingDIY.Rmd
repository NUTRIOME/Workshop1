...
data <- read_excel("C:/Users/mhpersso/Documents/NoMa_NMR_intervention_GEOcodes_Sent Susan.xlsx")
...
dataLocation <- paste0(getwd(), 'C:/Users/mhpersso/Documents/targets.csv')

# Load the targets data
treatmentData <- read.csv('C:/Users/mhpersso/Documents/targets.csv', header = TRUE)
